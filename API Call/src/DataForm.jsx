...
function DataForm() {
    ...
    useEffect(() => { 
        axios.get('https://guileless-hamster-837860.netlify.app/.netlify/functions/api') 
            .then((response) => { 
    ...
    const handleSubmit = (e, id = null) => { 
        ...
        const url = editItem 
            ? 'https://guileless-hamster-837860.netlify.app/.netlify/functions/api/${editItem._id}' 
            : 'https://guileless-hamster-837860.netlify.app/.netlify/functions/api'; 
    ...
    const handleDelete = (_id) => {
        axios
            .delete(
                `https://guileless-hamster-837860.netlify.app/.netlify/functions/api/${_id}`
            )
            .then(() => {
